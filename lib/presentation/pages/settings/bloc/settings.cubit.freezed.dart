...
mixin _$SettingsState {
 ...
 SettingsStatus get status; Settings? get settings; String? get errorMessage;
...
@useResult
$Res call({
 SettingsStatus status, Settings? settings, String? errorMessage
});
...
as SettingsStatus,settings: freezed == settings ? _self.settings : settings // ignore: cast_nullable_to_non_nullable
as Settings?,errorMessage: freezed == errorMessage ? _self.errorMessage : errorMessage // ignore: cast_nullable_to_non_nullable
as String?,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( SettingsStatus status,  Settings? settings,  String? errorMessage)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SettingsState() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( SettingsStatus status,  Settings? settings,  String? errorMessage)  $default,) {final _that = this;
switch (_that) {
case _SettingsState():
return $default(_that.status,_that.settings,_that.errorMessage);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( SettingsStatus status,  Settings? settings,  String? errorMessage)?  $default,) {final _that = this;
switch (_that) {
case _SettingsState() when $default != null:
return $default(_that.status,_that.settings,_that.errorMessage);case _:
  return null;
...
class _SettingsState extends SettingsState {
  const _SettingsState({this.status = SettingsStatus.initial, this.settings, this.errorMessage}): super._();
