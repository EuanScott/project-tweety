...
class Services {
  ...
  /// [body]: The data to include in the request body.
  Future<Map<String, dynamic>> putData(String path, {
    Map<String, String>? headers,
    required Map<String, dynamic> body,
    Encoding? encoding,
  }) async {
  ...
  Future<http.Response> sendHttpRequest(String method,
      String path, {
  ...
  ///
  /// This function takes a JSON string as input and uses the `jsonDecode` function
  /// from the `dart:convert` library to convert the JSON string into a Map<String, dynamic>.
  /// The resulting Map<String, dynamic> is then returned.
  ///
  /// [data]: A JSON string to be decoded.
  ///
  /// Returns a Map<String, dynamic> representation of the JSON string.
